...
Q1 = SimpleAttention2(256, 256, return_sequences=False)(DQ)
...
with io.open('../data/adam1e-42atte128enhancedev-prediction.json', 'w', encoding='utf-8') as f:
