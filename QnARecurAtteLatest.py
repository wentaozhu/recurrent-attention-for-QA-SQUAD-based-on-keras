...
import theano
from rnnlayer import Attention, SimpleAttention, SSimpleAttention, SimpleAttention2
from keras.models import Model
...
Q = Bidirectional(GRU(128, return_sequences=False))(questionEmbd)
#Qhpool = GlobalAveragePooling1D()(Q)
#Qhreshap = Reshape((64,))(Qh)
#D = Bidirectional(GRU(128, return_sequences=True))(contextEmbd)
#Q1 = Bidirectional(GRU(128, return_sequences=True))(Q)
#D1 = Bidirectional(GRU(128, return_sequences=True))(D)
#Q2 = GRU(128, return_sequences=False)(Q1)
Qh = RepeatVector(context_maxlen)(Q)
DQ = merge([Qh, contextEmbd], mode='concat', name='merge1')
D = SimpleAttention2(256, 256, return_sequences=False)(DQ)

#Dhpool = GlobalAveragePooling1D()(D)
#Dh = RepeatVector(question_maxlen)(Dhpool)
#QD1 = merge([Dh, Q], mode='concat', name='merge2')
#Q1 = SimpleAttention2(192, 128, return_sequences=True)(QD1)

#Qhpool1 = GlobalAveragePooling1D()(Q1)
#Qh1 = RepeatVector(context_maxlen)(Qhpool1)
#DQ1 = merge([Qh1, D], mode='concat', name='merge3')
#D1 = SimpleAttention2(192, 192, return_sequences=True)(DQ1)

#Dhpool1 = GlobalAveragePooling1D()(D1)
#Dh1 = RepeatVector(question_maxlen)(Dhpool1)
#QD2 = merge([Dh1, Q1], mode='concat', name='merge4')
#Q2 = SimpleAttention2(256, 192, return_sequences=False)(QD2)

#Qh2 = RepeatVector(context_maxlen)(Q2)
#DQ2 = merge([Qh2, D1], mode='concat', name='merge5')
#D2 = SimpleAttention2(256, 256, return_sequences=False)(DQ2)

L = merge([D, Q], mode='concat', name='merge6')

answerPtrBegin_output = Dense(context_maxlen, activation='softmax')(L)
Lmerge = merge([L, answerPtrBegin_output], mode='concat', name='merge7')
...
with io.open('../data/rms1atte128dev-prediction.json', 'w', encoding='utf-8') as f:
