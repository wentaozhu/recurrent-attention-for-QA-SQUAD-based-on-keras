...
GloveDimOption = '100' # this  could be 50 (171.4 MB), 100 (347.1 MB), 200 (693.4 MB), or 300 (1 GB)
...
DQ = merge([Dh, Q], mode='concat', name='merge1')
Q1 = SimpleAttention2(256, 256, return_sequences=True)(DQ)

Qhpool1 = GlobalAveragePooling1D()(Q1)
Qh1 = RepeatVector(context_maxlen)(Qhpool1)
QD1 = merge([Qh1, D], mode='concat', name='merge2')
D1 = SimpleAttention2(256, 256, return_sequences=True)(QD1)

Dhpool1 = GlobalAveragePooling1D()(D1)
Dh1 = RepeatVector(question_maxlen)(Dhpool1)
DQ1 = merge([Dh1, Q], mode='concat', name='merge3')
Q2 = SimpleAttention2(256, 256, return_sequences=False)(DQ1)

Qh2 = RepeatVector(context_maxlen)(Q2)
QD2 = merge([Qh2, D1], mode='concat', name='merge4')
D2 = SimpleAttention2(256, 256, return_sequences=True)(QD2)

output1 = TimeDistributed(Dense(1, activation='sigmoid'))(D2) # batchsize, len, 1
...
checkpoint3 = EarlyStopping(monitor='val_lambda_1_loss', min_delta=0.01, patience=5, verbose=0, mode='auto')
checkpoint4 = EarlyStopping(monitor='val_lambda_2_loss', min_delta=0.01, patience=5, verbose=0, mode='auto')
...
with io.open('../data/rms3atte128enhancedev-prediction.json', 'w', encoding='utf-8') as f:
