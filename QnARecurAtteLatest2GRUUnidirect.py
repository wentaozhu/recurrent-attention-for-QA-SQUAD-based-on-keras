...
Q = GRU(128, return_sequences=True)(questionEmbd)
D = GRU(128, return_sequences=True)(contextEmbd)
Q1 = GRU(192, return_sequences=True)(Q)
D1 = GRU(192, return_sequences=True)(D)
Q2 = GRU(256, return_sequences=False)(Q1)
D2 = GRU(256, return_sequences=False)(D1)
...
checkpoint3 = EarlyStopping(monitor='val_dense_1_loss', min_delta=0.01, patience=3, verbose=0, mode='auto')
checkpoint4 = EarlyStopping(monitor='val_dense_2_loss', min_delta=0.01, patience=3, verbose=0, mode='auto')
...
with io.open('../data/rms2undirectGRU128dev-prediction.json', 'w', encoding='utf-8') as f:
