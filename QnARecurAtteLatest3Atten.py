...
Qh = RepeatVector(context_maxlen)(Qhpool)
DQ = merge([Qh, contextEmbd], mode='concat', name='merge1')
D = SimpleAttention2(128, 128, return_sequences=True)(DQ)
...
L = merge([D2, Q2], mode='concat', name='merge6')
...
with io.open('../data/rms3atte128dev-prediction.json', 'w', encoding='utf-8') as f:
